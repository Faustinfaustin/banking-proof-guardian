...
import { CheckCircle, XCircle, Upload, Shield, AlertTriangle, FileCheck, Clock, Lock } from 'lucide-react';
...
const ComplianceVerifier = () => {
  ...
  const verifyRealProof = async () => {
    if (!proofData.trim() || !isGovAuthenticated) {
      return;
    }
  ...
  return (
    <div className="space-y-6">
        ...
        <Card className="bg-white/10 backdrop-blur-md border-white/20">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-blue-200">
              Administrative credentials required to verify proof generated by bank
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      {/* Verification Controls - Only shown after authentication */}
      {isGovAuthenticated && (
        <Card className="bg-white/10 backdrop-blur-md border-white/20">
          <CardHeader>
            <CardTitle className="text-white flex items-center">
              <Shield className="w-5 h-5 mr-2 text-green-400" />
              Government ZK Proof Verification Portal
              <Button 
      ...
      {/* Verification Result - Only shown after authentication */}
      {isGovAuthenticated && verificationResult && (
        <Card className="bg-white/10 backdrop-blur-md border-white/20">
          <CardHeader>
            <CardTitle className="text-white flex items-center">
            ...
            <div className="flex items-center justify-center p-6 rounded-lg border-2" 
              ...
              {verificationResult.isValid && verificationResult.compliance ? (
                <div className="text-center">
                  ...
                  <p className="text-green-300">All accounts comply with their respective limits</p>
                </div>
              ) : (
                <div className="text-center">
      ...
      {/* Information Panel - Only shown after authentication */}
      {isGovAuthenticated && (
        <Card className="bg-white/10 backdrop-blur-md border-white/20">
          <CardHeader>
            <CardTitle className="text-white flex items-center">
